...
public class Video {
    ...
    This adjustment was even more severe for lower fps*/
     ...
     public void genVideo(ArrayList<BufferedImage> list){
        ...
        for (Iterator<BufferedImage> it = list.iterator(); it.hasNext();) {
            writer.encodeVideo(0, it.next(), nextEncodeTime, TimeUnit.MILLISECONDS);
